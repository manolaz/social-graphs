...
"""
__all__ = [
    "partition_at_level", "modularity", "best_partition", "generate_dendogram",
    "induced_graph"
]
...
def __one_level(graph, status):
    ...
    while modif and nb_pass_done != __PASS_MAX:
        ...
        for node in graph.nodes():
            ...
            degc_totw = status.gdegrees.get(node,
                                            0.) / (status.total_weight * 2.)
...
def __main():
    ...
    try:
        ...
        print(
            "find the communities in graph filename and display the dendogram")
        print("Parameters:")
